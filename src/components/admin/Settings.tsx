          ...
          <form onSubmit={handleSaveUser} className="bg-[#0a001a]/95 border border-indigo-500/20 shadow-[0_24px_64px_rgba(0,0,0,0.9)] backdrop-blur-3xl w-full max-w-lg p-6 space-y-4 rounded-2xl">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <div className="block">
                ...
                <CustomSelect
                  options={clients.map((c) => ({ value: c.name, label: c.name.toUpperCase() }))}
                  value={editingUser.clientName}
                  onChange={(val) => setEditingUser({ ...editingUser, clientName: val })}
                />
              </div>
              <label className="block">
              ...
              <div className="block">
                ...
                <CustomSelect
                  ...
                  onChange={(val) => setEditingUser({ ...editingUser, timezone: val })}
                />
              </div>
              <div className="block">
                ...
                <CustomSelect
                  ...
                  value={editingUser.workMode}
                  onChange={(val) => setEditingUser({ ...editingUser, workMode: val as 'WFO' | 'WFH' })}
                />
              </div>
            </div>
